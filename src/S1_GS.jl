...
P1_TR = @visualize P1_TR * δ(inds(P1_TR)[2], inds(P1_BR)[1])
P1_TC = P1_TC * δ(inds(P1_TC)[2], inds(P1_TR)[1])
P1_TL = P1_TL * δ(inds(P1_TL)[2], inds(P1_TC)[1])
P1_BL = P1_BL * δ(inds(P1_BL)[2], inds(P1_TL)[1])
P1_BC = P1_BC * δ(inds(P1_BC)[2], inds(P1_BL)[1])
P1_BR = P1_BR * δ(inds(P1_BR)[2], inds(P1_BC)[1])
