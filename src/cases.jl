...
function case10b()
    rsg = new_plaquette(4)
    add_plaquette!(rsg, 1, 3, 6)
    add_plaquette!(rsg, 7, 5, 6)
    cap_all!(rsg)
...
function case11()
    rsg = new_plaquette(3)
    add_plaquette!(rsg, 1, 2, 4)
    add_plaquette!(rsg, 5, 3, 4)
    add_plaquette!(rsg, 6, 4, 4)
    cap_all!(rsg)
...
function case12()
    rsg = new_plaquette(4)
    add_plaquette!(rsg, 1, 2, 4)
    add_plaquette!(rsg, 6, 3, 4)
    add_plaquette!(rsg, 7, 4, 4)
    add_plaquette!(rsg, 8, 5, 4)
    cap_all!(rsg)

    contractionsequences = [collect(1:8)]
